...
function openDocumentPreview(e, url) {
  ...
  if (fileId) {
    ...
    openLightbox(`
      ...
      <iframe src="${previewUrl}" class="doc-preview" allow="autoplay" style="width: 100%; height: calc(90vh - 4rem); margin-top: 4rem; aspect-ratio: auto; border: none; border-radius: var(--radius-md); background: var(--c-surface);"></iframe>
    `);
  } else {
